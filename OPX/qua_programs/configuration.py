...
# Network parameters #
######################
qop_ip = "172.31.255.63"  # Write the QM router IP address
...
qubit_freq = 5810 * u.MHz
qubit_LO = 5.7 * u.GHz
qubit_IF = qubit_freq - qubit_LO
...
#                Resonators                 #
#############################################
resonator_freq = 6165.2 * u.MHz
resonator_LO = 6.2 * u.GHz
resonator_IF = resonator_freq - resonator_LO
        ...
        con: {
            ...
            "fems": {
                mw_fem: {
                    ...
                    "digital_outputs": {},
                    "analog_inputs": {
                        1: {"band": 2, "downconverter_frequency": resonator_LO, "gain_db":20},  # for down-conversion
                    },
                },
                lf_fem: {
                    "type": "LF",
