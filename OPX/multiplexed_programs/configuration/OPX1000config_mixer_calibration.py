...
_readout_amplitudes = np.array([0.05]*num_qubits) #0.3
...
_qubit_frequency = np.array([5000, 5885, 6000]) * u.MHz
_qubit_LO = np.array([4950, 5885, 6000]) * u.MHz
...
_x180_lens = [664, 40, 40, 40, 40, 40] # ns
