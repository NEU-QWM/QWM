...
n_reps = 250  # Number of times the full qubit spectrum is measured and recorded
n_avg = 100  # Number of averaging loops per repetition
res_key = "r1"
qubit_key = "q1"
...
if simulate:
    ...
    open_figs = [f for f in [fig_live, fig_map] if f is not None]
