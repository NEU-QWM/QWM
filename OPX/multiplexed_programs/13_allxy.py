...
qubit_key = "q1"
required_parameters = ["resonator_key", "readout_len", "qubit_frequency", "qubit_IF", "qubit_relaxation", "x180_len"]
res_key, readout_len, qubit_frequency, qubit_IF, qubit_relaxation, x180_len = single_qubit_parser(multiplexed_parameters.copy(), qubit_key, call_list=required_parameters)
...
def allXY(pulses):
    ...
    **Example:** I, Q = allXY(['I', 'y90'])
    ...
    if pulses[0] != "I":
        ...
        wait(x180_len // 4, qubit_key)  # or wait if sequence is identity
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot results
        plt.suptitle(f"{qubit_key}, All XY ({n+1}/{n_avg})")
        plt.subplot(211)
        plt.cla()
