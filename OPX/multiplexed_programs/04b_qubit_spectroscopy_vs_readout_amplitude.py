...
amplitudes = np.logspace(-2, 0, 100, endpoint=True)
    ...
    try:
        while res_handles.is_processing():
            ...
            if IQ:
                ...
                ax1.cla()
                im1 = ax1.pcolormesh(spec_sweep_dfs / u.MHz, amplitudes*readout_amp, I.T, shading='auto', cmap='viridis')
                ...
                ax2.cla()
                im2 = ax2.pcolormesh(spec_sweep_dfs / u.MHz, amplitudes*readout_amp, Q.T, shading='auto', cmap='viridis')
                ...
                ax1.cla()
                im1 = ax1.pcolormesh(spec_sweep_dfs / u.MHz, amplitudes*readout_amp, R.T, shading='auto', cmap='viridis')
                ax1.set_xlabel("Frequency Detuning (MHz)")
                ax1.set_ylabel("Pulse Amplitude (a.u.)")
                ...
                im2 = ax2.pcolormesh(spec_sweep_dfs / u.MHz, amplitudes*readout_amp, phase_unwrapped, shading='auto', cmap='viridis')
                ax2.set_xlabel("Frequency Detuning (MHz)")
                ax2.set_ylabel("Pulse Amplitude (a.u.)")
